...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Reporte de Talleres
	...
	<div class="card-body">
        ...
        <form action="" id="filter">
            <div class="d-flex  h-100 d-flex align-items-end">
                ...
                <div class="form-group col-3">
                    <label for="aid" class="control-label">Coordinador(a)</label>
    ...
    $(function(){
        ...
        $('#print_now').click(function(){
            ...
            var _el = $('<div>')
                ...
                _el.append("<h4 class='text-center'>Facultad Ciencias de la Salud</h4>")
